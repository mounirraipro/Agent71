...
const entries = [
  ...
  ['Agent 71 — Run your business, not your spreadsheets', 'Agent 71 — Pilotez votre entreprise, pas vos feuilles de calcul', 'Agent 71 — أعمالك أوضح، وقراراتك أسرع'],
  ['Agent 71 is a modern freemium ERP by HikariTech for finance, sales, inventory, purchasing and electronic invoicing.', 'Agent 71 est un ERP freemium moderne de HikariTech pour la finance, les ventes, les stocks, les achats et la facturation électronique.', 'Agent 71 منصة إدارة حديثة من HikariTech تجمع المالية والمبيعات والمخزون والمشتريات والفوترة الإلكترونية في مكان واحد.'],
  ...
  ['Run your', 'Pilotez votre', 'نمِّ'], ['business.', 'entreprise.', 'أعمالك.'],
  ['Not your spreadsheets.', 'Pas vos feuilles de calcul.', 'ودَع الجداول لنا.'],
  ['Finance, sales, inventory and accounting—together in one modern ERP.', 'Finance, ventes, stocks et comptabilité, réunis dans un ERP moderne.', 'من المبيعات والمخزون إلى المالية والمحاسبة، كل عملياتك في منصة واحدة واضحة.'],
  ['See the product', 'Voir le produit', 'اكتشف Agent 71'],
  ...
  ['Everything your business needs', 'Tout ce dont votre entreprise a besoin', 'أعمالك أمامك بوضوح'],
  ['to', 'pour', '—'], ['move faster.', 'avancer plus vite.', 'وقراراتك أقرب.'],
  ['See every number, connect every workflow, and turn insight into action.', 'Voyez chaque chiffre, reliez chaque processus et transformez les données en décisions.', 'الأرقام واضحة، والعمليات مترابطة، وما تحتاجه لاتخاذ القرار حاضر في وقته.'],
  ...
  ['Instant Visibility', 'Visibilité instantanée', 'صورة كاملة، لحظة بلحظة'], ['Real-time data across your', 'Des données en temps réel pour toutes vos', 'اعرف ما يجري في'], ['operations.', 'opérations.', 'كل جزء من أعمالك.'],
  ['How can I help you automate?', 'Que puis-je automatiser pour vous ?', 'ما العملية التي تريد تبسيطها؟'],
  ['When a quote is approved, create the invoice,', 'Lorsqu’un devis est approuvé, créez la facture,', 'بعد اعتماد عرض السعر، جهّز الفاتورة،'],
  ['reserve the stock, and notify finance.', 'réservez le stock et informez la finance.', 'احجز الكمية، وأبلغ فريق المالية تلقائياً.'],
  ['Automate', 'Automatiser', 'نفّذ تلقائياً'], ['Automated', 'Automatisé', 'تم التنفيذ'], ['Connected Workflows', 'Flux de travail connectés', 'عمليات تمشي بانسجام'],
  ['Automate processes with', 'Automatisez vos processus avec', 'دع Agent 71 يختصر عليك'],
  ['Time saved', 'Temps gagné', 'وقت استعدته لفريقك'], ['128 Hrs', '128 h', '128 ساعة'], ['↑ 18% efficiency', '↑ 18 % d’efficacité', '↑ كفاءة أعلى بـ 18%'],
  ['Action: Approve', 'Action : Approuver', 'الخطوة التالية: اعتماد'], ['Decision Confidence: 98%', 'Confiance décisionnelle : 98 %', 'وضوح القرار: 98%'], ['Path Optimized: +14.2%', 'Parcours optimisé : +14,2 %', 'تحسن المسار: +14.2%'],
  ['Faster Decisions', 'Décisions plus rapides', 'قرار أسرع، بثقة أكبر'], ['Turn insights into action', 'Transformez les données en actions', 'حوّل الصورة الواضحة إلى خطوة'], ['instantly.', 'instantanément.', 'في وقتها.'],

  ['Ready for Morocco’s', 'Prêt pour la transition marocaine vers', 'استعدّ من الآن'], ['e-invoicing shift.', 'la facture électronique.', 'للفوترة الإلكترونية في المغرب.'],
  ['Create structured invoices, keep the right records, and connect compliance to the rest of your operation.', 'Créez des factures structurées, conservez les bons justificatifs et reliez la conformité à vos opérations.', 'أصدر فواتير منظمة، واحفظ بياناتها في مسار واحد يمكن مراجعته وتطويره مع المتطلبات الجديدة.'],
  ...
  ['Every part of your business,', 'Toutes les dimensions de votre entreprise,', 'أعمالك كلها،'], ['moving in one flow.', 'avancent dans un même flux.', 'تتحرك بتناغم.'],
  ['Feeling ready?', 'Prêt à avancer ?', 'جاهز للخطوة التالية؟'], ['Navigation', 'Navigation', 'التنقل'], ['How it works', 'Fonctionnement', 'كيف يعمل'], ['Features', 'Fonctionnalités', 'الميزات'], ['Product scope', 'Périmètre produit', 'نطاق المنتج'],
  ...
  ['All rights reserved.', 'Tous droits réservés.', 'جميع الحقوق محفوظة.'], ['Business moves fast.', 'L’entreprise avance vite.', 'السوق لا ينتظر.'], ['Stay ahead with Agent 71.', 'Gardez une longueur d’avance avec Agent 71.', 'ابقَ في الصدارة مع Agent 71.'],
  ...
  ['Your whole business.', 'Toute votre entreprise.', 'كل أعمالك، في مكان واحد.'], ['One living system.', 'Un seul système vivant.', 'منظومة تعمل معك.'],
  ['Agent 71 connects the work your teams do with the records your business needs—without the spreadsheet handoffs or legacy ERP weight.', 'Agent 71 relie le travail de vos équipes aux données dont votre entreprise a besoin, sans transferts entre feuilles de calcul ni lourdeur des ERP traditionnels.', 'يربط Agent 71 فرقك وعملياتك وبياناتك في تجربة واحدة، من دون تنقّل مرهق بين ملفات Excel أو أنظمة قديمة معقدة.'],
  ['Explore the system', 'Explorer le système', 'اكتشف ما يمكنك إنجازه'], ['Connected Agent 71 workflows', 'Flux Agent 71 connectés', 'كيف تتكامل العمليات داخل Agent 71'],
  ['Agent 71 workspace', 'Espace Agent 71', 'مساحة أعمالك على Agent 71'], ['Connected by design', 'Connecté par conception', 'كل شيء متصل'], ['One source of truth', 'Une source unique de vérité', 'معلومة واحدة يعتمد عليها الجميع'],
  ['Every action updates the next team.', 'Chaque action met à jour l’équipe suivante.', 'ما ينجزه فريق يصل إلى الفريق التالي فوراً.'], ['Live', 'En direct', 'الآن'],
  ...
  ['Records stay connected', 'Les données restent connectées', 'كل سجل يكمّل ما بعده'], ['Sales · Finance · Stock · People', 'Ventes · Finance · Stock · Équipes', 'المبيعات · المالية · المخزون · الفريق'],
  ['Explore the system.', 'Explorez le système.', 'من أين تريد أن تبدأ؟'], ['Five connected areas. One operational record.', 'Cinq domaines connectés. Un seul registre opérationnel.', 'خمسة مجالات تعمل معاً، وسجل واحد يجمعها.'],
  ['Choose an area to see how Agent 71 is being shaped around the way modern businesses sell, move, account, and grow.', 'Choisissez un domaine pour découvrir comment Agent 71 s’adapte à la façon dont les entreprises modernes vendent, opèrent, comptabilisent et se développent.', 'اختر المجال الأقرب لعملك، واكتشف كيف يساعد Agent 71 فريقك على البيع والتشغيل والمتابعة والنمو من منصة واحدة.'],
  ['Product areas', 'Domaines du produit', 'مجالات أعمالك'], ['Representative product direction', 'Orientation produit indicative', 'تصوّر أولي للمنتج'], ['Availability and timing will be announced as Agent 71 develops.', 'La disponibilité et le calendrier seront annoncés au fil du développement d’Agent 71.', 'سنعلن عن توفر كل ميزة وموعد إطلاقها مع تقدم تطوير Agent 71.'],
  ['Sell & serve', 'Vendre & servir', 'المبيعات والعملاء'], ['From first conversation to money in the bank.', 'Du premier échange jusqu’à l’encaissement.', 'من أول تواصل مع العميل إلى تحصيل المبلغ.'],
  ['Keep the customer, quote, order, invoice, payment, and follow-up in one continuous record.', 'Gardez le client, le devis, la commande, la facture, le paiement et le suivi dans un dossier continu.', 'تابع العميل وعرض السعر والطلب والفاتورة والتحصيل في مسار واحد، من دون أن تضيع التفاصيل بين الأدوات.'],
  ...
  ['Control finance', 'Piloter la finance', 'المالية والمحاسبة'], ['A financial record built as the business moves.', 'Une comptabilité qui se construit au rythme de l’activité.', 'حساباتك تتحدث تلقائياً مع كل عملية.'],
  ['Operational activity becomes structured accounting, so finance can close faster and explain every number.', 'L’activité opérationnelle devient une comptabilité structurée pour clôturer plus vite et expliquer chaque chiffre.', 'تتحول المبيعات والمشتريات والحركات اليومية إلى قيود منظمة، لتغلق الفترة أسرع وتعرف مصدر كل رقم.'],
  ...
  ['Move goods', 'Gérer les flux', 'المخزون والتوريد'], ['Know what is available, committed, and coming next.', 'Sachez ce qui est disponible, engagé et attendu.', 'اعرف ما لديك، وما حُجز، وما تحتاجه قريباً.'],
  ['Connect purchasing, warehouses, planning, and production without losing the financial impact of each move.', 'Reliez achats, entrepôts, planification et production sans perdre l’impact financier de chaque mouvement.', 'اربط الشراء والمستودعات والتخطيط والإنتاج، واعرف أثر كل حركة على التكلفة والسيولة.'],
  ...
  ['Run the team', 'Piloter les équipes', 'الفريق والتنفيذ'], ['Give work an owner, a deadline, and a cost.', 'Donnez à chaque tâche un responsable, une échéance et un coût.', 'لكل مهمة مسؤول، ولكل موعد متابعة، ولكل مشروع تكلفة واضحة.'],
  ['Bring people records and day-to-day delivery together, from attendance to projects and field operations.', 'Réunissez les dossiers collaborateurs et l’exécution quotidienne, de la présence aux projets et opérations terrain.', 'اجمع بيانات الموظفين والعمل اليومي في مكان واحد، من الحضور والإجازات إلى المشاريع والعمليات الميدانية.'],
  ...
  ['Connect it all', 'Tout connecter', 'منصة تنمو معك'], ['One platform that can grow without starting over.', 'Une plateforme qui grandit sans tout recommencer.', 'أضف ما تحتاجه من دون أن تبدأ من الصفر.'],
  ['A modular foundation for companies, branches, languages, permissions, automations, and external systems.', 'Une base modulaire pour sociétés, filiales, langues, droits, automatisations et systèmes externes.', 'ابدأ ببساطة، ثم وسّع النظام ليشمل الشركات والفروع واللغات والصلاحيات والأتمتة والتكاملات.'],
  ...
  ['Global ERP thinking.', 'Une vision ERP globale.', 'قدرات عالمية.'], ['Built for Morocco.', 'Conçu pour le Maroc.', 'وتفاصيل مغربية.'],
  ['Agent 71 pairs broad operational capability with the localization Moroccan businesses actually need.', 'Agent 71 associe une large couverture opérationnelle à la localisation dont les entreprises marocaines ont réellement besoin.', 'صممنا Agent 71 ليوفر قوة أنظمة ERP الحديثة، مع العملات والضرائب والوثائق وسير العمل الذي تعرفه الشركات المغربية.'],
  ...
  ['Agent 71 is in development.', 'Agent 71 est en cours de développement.', 'Agent 71 ما زال قيد التطوير.'], ['Tell us what your', 'Dites-nous ce dont votre', 'نريد أن نبنيه'], ['business needs.', 'entreprise a besoin.', 'حول احتياجاتك.'],

  ['Morocco is changing', 'Le Maroc transforme', 'الفاتورة في المغرب'], ['how invoices', 'la circulation des', 'تدخل مرحلة'], ['move.', 'factures.', 'رقمية جديدة.'],
  ["Agent 71 is being designed to keep invoice data clean, connected, and ready to adapt as Morocco’s electronic-invoicing framework becomes operational.", 'Agent 71 est conçu pour garder les données de facturation propres, connectées et prêtes à évoluer avec la mise en œuvre du cadre marocain.', 'نبني Agent 71 ليحافظ على بيانات فواتيرك منظمة ومترابطة، ويمنحك المرونة اللازمة لمواكبة الإطار المغربي عند بدء تطبيقه.'],
  ['Prepare your business', 'Préparer votre entreprise', 'ابدأ الاستعداد'], ['Understand the framework', 'Comprendre le cadre', 'اعرف ما تغيّر'],
  ...
  ['Illustrative future-ready invoicing workflow', 'Flux illustratif de facturation prêt pour l’avenir', 'تصوّر مبسط لمسار الفاتورة الرقمية'], ['Agent 71 invoice flow', 'Flux de facturation Agent 71', 'مسار الفاتورة داخل Agent 71'], ['Designed to adapt', 'Conçu pour évoluer', 'جاهز للتطور'],
  ['Business record', 'Donnée métier', 'بيانات الفاتورة'], ['Validation layer', 'Couche de validation', 'التحقق والمراجعة'], ['Required channel', 'Canal requis', 'قناة الإرسال المعتمدة'], ['Complete identifiers', 'Identifiants complets', 'بيانات تعريف مكتملة'], ['Traceable status', 'Statut traçable', 'حالة واضحة في كل خطوة'], ['Adaptable mapping', 'Mapping adaptable', 'تكامل قابل للتحديث'],
  ['Illustrative product direction. Final regulatory integration will follow the specifications applicable at launch.', 'Orientation produit illustrative. L’intégration réglementaire finale suivra les spécifications applicables au lancement.', 'هذا تصوّر للمنتج، أما الربط التنظيمي النهائي فسيعتمد المواصفات الرسمية السارية عند الإطلاق.'],
  ['More than a PDF.', 'Bien plus qu’un PDF.', 'ليست مجرد نسخة PDF.'], ['The practical shift is from a document people read to data that systems can also process, verify, and track.', 'Le changement consiste à passer d’un document lu par des personnes à des données que les systèmes peuvent traiter, vérifier et suivre.', 'الفكرة أن تتحول الفاتورة من ملف يُقرأ فقط إلى بيانات تستطيع الأنظمة فهمها والتحقق منها وتتبع حالتها.'],
  ['Structured at the source', 'Structurée dès la source', 'بيانات صحيحة من البداية'], ['Invoice data needs to be consistent and machine-readable, not trapped inside manually prepared documents.', 'Les données doivent être cohérentes et lisibles par machine, pas enfermées dans des documents préparés manuellement.', 'ينبغي إدخال بيانات الفاتورة بطريقة موحدة وقابلة للمعالجة آلياً، لا أن تبقى محصورة في مستندات تُعد يدوياً.'],
  ['Connected to the process', 'Connectée au processus', 'جزء من سير العمل'], ['Issuing, receiving, correcting, and tracking invoices should become a controlled workflow instead of an email trail.', 'Émission, réception, correction et suivi doivent former un flux maîtrisé, plutôt qu’une suite d’e-mails.', 'الإصدار والاستلام والتصحيح والمتابعة خطوات في مسار واضح، وليست مراسلات متفرقة يصعب الرجوع إليها.'],
  ['Traceable by design', 'Traçable par conception', 'كل خطوة لها أثر'], ['Identity, integrity, timestamps, statuses, and changes need a reliable history that finance teams can explain.', 'Identité, intégrité, horodatage, statuts et changements nécessitent un historique fiable que la finance peut expliquer.', 'هوية الفاتورة وحالتها وتوقيتها وكل تعديل عليها محفوظ في سجل يستطيع فريق المالية مراجعته وشرحه.'],
  ['What is clear.', 'Ce qui est clair.', 'ما نعرفه اليوم.'], ['What is still moving.', 'Ce qui évolue encore.', 'وما ننتظر تفاصيله.'], ['We separate published legal foundations from implementation details that businesses should continue to verify.', 'Nous distinguons les bases juridiques publiées des modalités d’application que les entreprises doivent continuer à vérifier.', 'نميّز هنا بين الأساس القانوني المنشور وبين تفاصيل التطبيق التي ما زالت تحتاج إلى متابعة وتحقق.'],
  ...
  ['Prepare the parts', 'Préparez dès maintenant', 'ابدأ بما تستطيع'], ['you control today.', 'ce que vous maîtrisez.', 'تحسينه من اليوم.'], ['Preparation, in five moves', 'Se préparer en cinq étapes', 'خمس خطوات عملية للاستعداد'], ['Control what you can.', 'Maîtrisez ce qui dépend de vous.', 'رتّب ما تملكه اليوم.'], ['Stay ready for what changes.', 'Restez prêt pour la suite.', 'وابقَ جاهزاً لما سيتغير.'], ['Scroll to explore', 'Faites défiler pour explorer', 'مرّر لاكتشاف الخطوات'], ['You do not need to guess the final specification to improve the quality of your data and process.', 'Vous n’avez pas besoin de deviner la spécification finale pour améliorer vos données et processus.', 'لست بحاجة إلى انتظار كل التفاصيل التقنية حتى ترتب بياناتك وتوضح مسؤوليات فريقك وتحسن دورة الفاتورة.'],
  ...
  ['Built to adapt', 'Conçu pour évoluer', 'مصمم ليتكيف'], ['How Agent 71 is being built for the shift.', 'Comment Agent 71 se prépare à la transition.', 'كيف يستعد Agent 71 للمرحلة القادمة؟'], ['Structured source records, configurable invoice fields, controlled corrections, status history, role-based approvals, and an integration layer that can evolve when the final rules are published.', 'Données sources structurées, champs configurables, corrections contrôlées, historique des statuts, validations par rôle et couche d’intégration évolutive.', 'بيانات منظمة من المصدر، وحقول قابلة للتهيئة، وتصحيحات مضبوطة، وسجل واضح للحالات والموافقات، وطبقة تكامل يمكن تحديثها عند صدور المواصفات النهائية.'],
  ['Discuss your invoicing workflow', 'Parler de votre flux de facturation', 'حدّثنا عن دورة الفوترة لديك'], ['Official references.', 'Références officielles.', 'لمن يريد الرجوع إلى المصدر.'], ['Regulatory guidance changes. Verify your situation with the DGI and a qualified adviser.', 'Les orientations évoluent. Vérifiez votre situation auprès de la DGI et d’un conseiller qualifié.', 'التوجيهات التنظيمية قابلة للتحديث، لذلك تحقق من وضع شركتك لدى المديرية العامة للضرائب ومستشار مختص.'],
